(function (global, factory) {
  ...
  (global = global || self, global['stimulus-shortcut'] = factory(global.Stimulus));
    ...
    _createClass(_default, [{
      ...
      value: function initialize() {
        if (this.keyValue) {
          ...
          this.element.dataset.controller = this.element.dataset.controller.split(' ').filter(controller => controller !== 'shortcut').join(' ');
          return;
        }
      ...
      key: "actOnHotkey",
      value: function actOnHotkey(func) {
        setTimeout(() => {
      ...
      key: "newEvent",
      value: function newEvent(element, event) {
